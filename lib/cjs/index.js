    ...
    constructor() {
        ...
        this.digest = (rawGSI) => {
            ...
            const gsi = {
                ...
                runes: utils_js_1.parseRunes(rawGSI.map.clock_time, rawGSI.map.game_time, (_b = this.last) === null || _b === void 0 ? void 0 : _b.runes, rawGSI.minimap, rawGSI.events, players),
                draft: {
