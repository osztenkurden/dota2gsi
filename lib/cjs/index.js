...
class DOTA2GSI {
    constructor() {
        ...
        this.digest = (rawGSI) => {
            ...
            const players = rawPlayers.map(data => utils_js_1.parsePlayer(data.player, data.id, rawGSI, this.players));
            const gsi = {
                ...
                draft: {
                    ...
                    radiant: rawGSI.draft.team2 && 'home_team' in rawGSI.draft.team2 && rawGSI.draft.radiant_bonus_time !== undefined ? {
                    ...
                    dire: rawGSI.draft.team3 && 'home_team' in rawGSI.draft.team3 && rawGSI.draft.dire_bonus_time !== undefined ? {
