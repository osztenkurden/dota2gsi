...
const items_prices_js_1 = require("./items_prices.js");
Object.defineProperty(exports, "getItem", { enumerable: true, get: function () { return items_prices_js_1.getItem; } });
...
class DOTA2GSI {
    constructor() {
        ...
        this.digest = (rawGSI) => {
            ...
            const runes = utils_js_1.parseRunes(rawGSI.map.clock_time, rawGSI.map.game_time, (_a = this.last) === null || _a === void 0 ? void 0 : _a.runes, rawGSI.minimap, rawGSI.events, players);
            console.log({ runes, gameTime: rawGSI.map.game_time, clockTime: rawGSI.map.clock_time });
            console.log({ rawGSI });
            const gsi = {
                ...
                neutral_items: utils_js_1.parseNeutralItems(rawGSI.map.game_time, rawGSI.neutralitems, ((_b = this.last) === null || _b === void 0 ? void 0 : _b.neutral_items) || undefined) ||
                    null,
