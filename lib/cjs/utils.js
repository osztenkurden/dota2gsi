...
exports.parseNeutralItems = exports.parseOutposts = exports.parseCourier = exports.parseDraft = exports.parseBuilding = exports.parseMap = exports.parseTeam = exports.parsePlayer = void 0;
...
const getPlayersCourier = (id, couriers, lastCouriers, team) => {
    for (const courier in couriers) {
        if (Number(couriers[courier].owner) === id)
            return exports.parseCourier(couriers[courier], lastCouriers[id], team);
    }
    return undefined;
};
...
const parseCourier = (courier, lastCourier, team) => {
    const items = [];
