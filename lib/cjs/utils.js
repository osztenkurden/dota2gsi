...
const parseOutposts = (minimap) => {
    ...
    return {
        south: !(south === null || south === void 0 ? void 0 : south.team) ? undefined : south.team === 2 ? 'radiant' : 'dire',
        north: !(north === null || north === void 0 ? void 0 : north.team) ? undefined : north.team === 2 ? 'radiant' : 'dire'
    };
};
