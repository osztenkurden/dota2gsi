...
const parseRunes = (currentClockTime, currentGameTime, lastRunes, minimap, events, players) => {
    ...
    else if ((!result.leftPower || !result.leftPower.exists) && runes.find(x => x.ypos > 0)) {
        const rune = runes.find(x => x.ypos > 0);
        if (rune) {
            result.leftPower = {
                appearedAt: (_b = result.leftPower) === null || _b === void 0 ? void 0 : _b.nextAppearsAt,
    ...
    if (((_c = result.rightPower) === null || _c === void 0 ? void 0 : _c.exists) && !runes.find(x => x.ypos < 0)) {
        result.rightPower = nextPowerRune(currentTime);
    }
    else if ((!((_d = result.rightPower) === null || _d === void 0 ? void 0 : _d.exists)) && runes.find(x => x.ypos < 0)) {
        const rune = runes.find(x => x.ypos < 0);
        if (rune) {
            result.rightPower = {
                appearedAt: (_e = result.rightPower) === null || _e === void 0 ? void 0 : _e.nextAppearsAt,
                type: rune === null || rune === void 0 ? void 0 : rune.type,
                nextAppearsAt: nextPowerRuneTime(currentTime),
                exists: true
            };
