...
import { parseBuilding, parseDraft, parseMap, parseNeutralItems, parseOutposts, parsePlayer, parseRunes } from './utils.js';
class DOTA2GSI {
    constructor() {
        this.eventNames = () => {
        ...
        this.digest = (rawGSI) => {
            ...
            const runes = parseRunes(rawGSI.map.clock_time, rawGSI.map.game_time, this.last?.runes, rawGSI.minimap, rawGSI.events, players);
            ...
            const gsi = {
                ...
                neutral_items: parseNeutralItems(rawGSI.map.game_time, rawGSI.neutralitems, this.last?.neutral_items || undefined) ||
                    null,
