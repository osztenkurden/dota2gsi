...
import { BuildingInfo, CourierRaw, GSIEvent, MapRaw, MinimapPoint, NeutralItemsRaw, TeamBuildingsKeys, TeamDraftRaw } from './dota2';
...
export declare const parseRunes: (currentClockTime: number, currentGameTime: number, lastRunes?: Runes | undefined, minimap?: {
    [pointName: string]: MinimapPoint;
} | undefined, events?: GSIEvent[] | undefined, players?: Player[] | undefined) => Runes;
